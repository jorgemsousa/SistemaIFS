    ...
    <div class="page-wrapper">
        ...
        <header class="header text-center">
            <div class="container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Excluir Administradores</li>
                </ol>
               </span> 
            </div><!--//container-->
        </header><!--//header-->
        ...
        <section class="cards-section text-center">
            <div class="container" >              
               ...
               <h3 class="question">Exclusão de Administradores</h3>
                <form name="deleteAdm" method="POST" action="../Controller/AdmExclui.ctl.php">
